...
import { Calendar, Badge, Panel, Stack, Divider, Button, Modal, Radio, RadioGroup, Message, useToaster, SelectPicker, CustomProvider } from 'rsuite';
import ptBR from 'rsuite/locales/pt_BR'; // Importação do idioma Português
...
export default function Agenda() {
  ...
  // ========================================================================
  // AQUI FAZ O CANCELAMENTO E SALVA NO HISTÓRICO PARA O DASHBOARD LER
  // ========================================================================
  ...
  // ========================================================================
  // AQUI CONCLUI O ATENDIMENTO E MARCA O TIPO DE PAGAMENTO
  // ========================================================================
  ...
  // Envolve todo o retorno do componente com CustomProvider para aplicar o ptBR
  return (
                ...
                return (
                  <Panel key={ag.id} shaded style={{ marginBottom: 15, borderLeft: `4px solid ${corStatus}`, background: theme.light }}>
                    ...
                    <Stack spacing={6}>
                      ...
                      {/* AQUI BLOQUEIA O CANCELAMENTO SE O STATUS FOR CONCLUIDO */}
                      <Button size="xs" disabled={statusAtual === 'concluido'} onClick={() => iniciarCancelamento(ag)} style={{ color: statusAtual === 'concluido' ? theme.muted : theme.danger, background: 'transparent' }}>
                        Cancelar
                      </Button>
                    </Stack>
                  </Panel>
